...
## Краткое описание:  
Целью данного проекта является разработка сайта, который позволит клиентам арендовать спортивное оборудование и произвести оплату онлайн, а кроме того упростит продавцам учёт заказов и списка оборудования.  
...
[Видео про использование приложения](https://youtu.be/sG3JJIwiAA8)
